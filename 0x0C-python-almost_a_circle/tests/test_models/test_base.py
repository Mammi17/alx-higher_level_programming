#!/usr/bin/python3
"""it is the base.py unittest module."""
...
class Test_Base_ID(TestCase):
    ...
    def test_ID_positive(self):
        self.assertEqual(Base(43).id, 43)
    ...
    def test_ID_mixed(self):
        ...
        self.assertEqual(Base(42).id, 43)
...
class Test_Base_save_to_file(TestCase):
    ...
    def test_save_to_file_overwrite(self):
        s = Square(2, 1, 2, 43)
        Square.save_to_file([s])
        s = Square(43, 43, 43, 43)
        Square.save_to_file([s])
        with open("Square.json", 'r') as f:
            self.assertTrue(len(f.read()) == 43)
...
class Test_Base_save_to_file_csv(TestCase):
    ...
    def test_save_to_file_csv_basic_rectangle(self):
        ...
        with open("Rectangle.csv", 'r') as f:
            self.assertEqual(f.read(), '43,2,4,1,2\n')

    def test_save_to_file_csv_basic_square(self):
        s = Square(2, 1, 2, 43)
        Square.save_to_file_csv([s])
        with open("Square.csv", 'r') as f:
            self.assertEqual(f.read(), '43,2,1,2\n')
    ...
    def test_save_to_file_csv_overwrite(self):
        ...
        Square.save_to_file_csv([s])
        with open("Square.csv", 'r') as f:
            self.assertEqual(f.read(), '43,43,43,43\n')
