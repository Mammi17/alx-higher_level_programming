"""it is the rectangle.py unittest module."""
...
class Test_Rectangle_values(TestCase):
    ...
    def test_y_invalid_type(self):
        for type in self.types:
            with self.subTest(type=type):
                with self.assertRaisesRegex(TypeError, "value of y must be an integer"):
                    Rectangle(2, 4, 0, type)

    def test_y_invalid_value(self):
        with self.assertRaisesRegex(ValueError, "value of y must be >= 0"):
            Rectangle(2, 4, 0, -43)
...
class Test_Rectangle_str(TestCase):
    ...
    def test_str_print(self):
        expected = "[Rectangle] (43) 1/3 - 2/4"
        with mock.patch('sys.stdout', new=StringIO()) as output:
            print(Rectangle(2, 4, 1, 3, 43), end='')
...
class Test_Rectangle_update_with_args(TestCase):
    ...
    def test_update_no_args(self):
        r = Rectangle(2, 4, 1, 2, 43)
        r.update()
        self.assertEqual(str(r), "[Rectangle] (43) 1/2 - 2/4")
...
class Test_Rectangle_update_with_kwargs(TestCase):
    ...
    def test_update_kwargs_args_before(self):
        ...
        self.assertEqual(str(r), "[Rectangle] (43) 1/2 - 43/43")

    def test_update_kwargs_not_all_mixed(self):
        r = Rectangle(2, 4, 1, 2, 43)
        r.update(y=10, x=10, height=10)
        self.assertEqual(str(r), "[Rectangle] (43) 10/10 - 2/10")
